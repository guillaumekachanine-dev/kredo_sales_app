    ...
    <>
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-border bg-surface px-4 py-3">
        ...
        <button
          ...
          className="inline-flex min-h-9 shrink-0 items-center gap-2 rounded border border-primary bg-primary px-4 text-xs font-bold text-primary-fg transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/35 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
        >
      ...
      <WorkflowExecutionConfirmDialog
        ...
        actionLabel="Mettre à jour l’entreprise"
    ...
    <>
      <div className="mb-3 space-y-2">
        <button
          ...
          disabled={status === "running"}
          aria-busy={status === "running"}
          className="inline-flex min-h-[44px] w-full items-center justify-center gap-1.5 rounded-lg bg-primary px-3.5 py-2.5 text-xs font-bold text-primary-fg shadow-sm transition-all active:scale-98 disabled:opacity-60 cursor-pointer"
        >
          {status === "running" ? "Mise à jour en cours…" : "Mettre à jour l’entreprise"}
        </button>
