  ...
  public: {
    Tables: {
      ...
      ai_intelligence_logs: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["result_id"]
            isOneToOne: false
            referencedRelation: "v_ai_result_costs"
      ...
      ai_intelligence_runs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ai_intelligence_runs_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      ai_model_pricing: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_model_pricing_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      calendar_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "calendar_events_collaborator_id_fkey"
      ...
      companies: {
        Row: {
          classification_confiance: string | null
      ...
      intelligence_documents: {
        Row: {
          ...
          source_financial_model_id: string | null
          source_result_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "fk_intelligence_documents_source_financial_model"
            columns: ["source_financial_model_id", "workspace_id"]
            isOneToOne: false
            referencedRelation: "financial_models"
            referencedColumns: ["id", "workspace_id"]
          },
      ...
      value_chain_actors: {
        ...
        Relationships: [
          {
            foreignKeyName: "value_chain_actors_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "value_chain_actors_node_id_fkey"
            columns: ["node_id"]
            isOneToOne: false
            referencedRelation: "value_chain_nodes"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "value_chain_actors_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      value_chain_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "value_chain_links_node_amont_fkey"
            columns: ["node_amont"]
            isOneToOne: false
            referencedRelation: "value_chain_nodes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "value_chain_links_node_aval_fkey"
            columns: ["node_aval"]
            isOneToOne: false
            referencedRelation: "value_chain_nodes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "value_chain_links_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      value_chain_nodes: {
        Row: {
          capture_justification: string | null
          capture_valeur: number | null
          confiance: string
          couche: string
          created_at: string
          description: string | null
      ...
      veille_articles: {
        ...
        Relationships: [
          {
            foreignKeyName: "veille_articles_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      v_ai_result_costs: {
        Row: {
          ...
          owner_id: string | null
          phase: number | null
          pricing_missing: boolean | null
          result_id: string | null
          result_type: string | null
          run_id: string | null
          status: Database["public"]["Enums"]["ai_result_status"] | null
          tokens_input: number | null
          tokens_missing: boolean | null
          tokens_output: number | null
          workspace_id: string | null
        }
        Relationships: [
      ...
      v_workflow_cost_stats: {
        Row: {
          avg_cost_30d: number | null
          avg_cost_all_time: number | null
          avg_tokens_input_30d: number | null
          avg_tokens_output_30d: number | null
          has_pricing_gap: boolean | null
          has_tokens_gap: boolean | null
          run_type: string | null
    ...
    Functions: {
      ...
      import_account_scan_contacts: {
        Args: {
          p_allow_existing_updates?: boolean
          p_candidate_keys: string[]
          p_result_id: string
        }
        Returns: Json
      }
