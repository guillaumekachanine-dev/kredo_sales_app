...
export const MATCH_VERSION = "matching-v1.0"

// Somme = 100. Les compétences dominent : c'est un moteur de staffing, pas un
// classement générique. La renormalisation sur composantes applicables (cf.
// compute-match.ts) fait que ces poids sont relatifs, pas absolus.
