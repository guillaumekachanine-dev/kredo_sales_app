...
// Supprimée le 2026-09-11 (contrats account_knowledge V1→V4, INTEL-030/035).
// La connaissance d'un compte vient désormais d'une étude de recherche importée :
// voir `src/features/account-research-studies/`.
