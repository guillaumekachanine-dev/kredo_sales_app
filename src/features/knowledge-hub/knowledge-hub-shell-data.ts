...
export const workshops: WorkshopItem[] = [
  {
    ...
    mobilizedKnowledge: ["AO & Propositions", "Expertises KREDO", "Delivery & REX"],
    icon: "📄",
    status: "À venir",
  },
  {
  ...
  },
  {
    ...
    mobilizedKnowledge: ["Delivery & REX", "Expertises KREDO"],
    icon: "⚖️",
    status: "À venir",
  },
  {
    ...
    mobilizedKnowledge: ["Expertises KREDO", "AO & Propositions"],
    icon: "🎨",
    status: "À venir",
  },
  {
  ...
  },
  {
    ...
    mobilizedKnowledge: ["Delivery & REX", "Ressources admin"],
    icon: "👥",
    status: "À venir",
  },
  {
  ...
  },
  {
    ...
    mobilizedKnowledge: ["Ressources admin", "Talents"],
    icon: "🛡️",
    status: "À venir",
  },
]
