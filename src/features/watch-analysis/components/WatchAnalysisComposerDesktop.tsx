...
export function WatchAnalysisComposerDesktop({
  ...
  return (
    <IntelligenceSplitModalShell
      ...
      subtitle={composer.screen === "compose" ? "1 à 3 groupes de sources, complétés par une intention" : SOURCE_FAMILY_LABELS[activeFamily]}
      leftPane={null}
      rightPane={null}
      headerActions={
    ...
    <div className="flex h-full flex-col overflow-hidden">
      <div className="flex-1 overflow-y-auto p-6">
        <div className="mx-auto max-w-2xl space-y-5">
                  ...
                  {source ? (
                    <div className="mt-2 flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="truncate text-sm font-bold text-white">{label.title}</p>
                      ...
                      <div className="flex shrink-0 items-center gap-2">
                        <button
                          ...
                          className="rounded-lg px-2.5 py-1.5 text-xs font-semibold text-primary hover:bg-white/5"
                        >
                          Remplacer
                        </button>
                        <button
                          ...
                          className="rounded-lg px-2.5 py-1.5 text-xs font-semibold text-white/60 hover:bg-white/5 hover:text-danger"
                        >
                          Retirer
                        </button>
                      </div>
                    ...
                    <button
                      type="button"
                      onClick={() => onOpenPicker(slotIndex)}
                      className="mt-2 flex min-h-11 w-full items-center gap-2 rounded-xl border border-dashed border-white/15 px-3 text-sm font-semibold text-white/70 hover:border-primary/50 hover:text-primary"
                    >
          ...
          <div>
            <label htmlFor="watch-analysis-intention" className="text-[10px] font-bold uppercase tracking-[0.1em] text-white/50">
