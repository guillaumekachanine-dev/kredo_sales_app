...
const SETTINGS_SELECT =
  "id,is_enabled,watch_level,cadence,include_official_site,include_news,include_jobs,include_public_records,include_tenders,include_social_manual,query_aliases,metadata"
