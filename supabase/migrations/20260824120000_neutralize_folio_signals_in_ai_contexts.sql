-- Migration : Neutralisation des signaux FOLIO legacy dans les contextes IA (Lot 2).
-- Expurge la clé 'signaux' de folioAnalysisData ((metadata->'analysis_data') - 'signaux').

-- ─────────────────────────────────────────────────────────────────────────────
-- 1. get_account_knowledge_context (intel-030)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2. get_account_issues_context (intel-031)
-- ─────────────────────────────────────────────────────────────────────────────
