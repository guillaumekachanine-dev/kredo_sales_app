-- Migration: correct_lot2_save_rules
-- Targeted corrections on public.save_financial_model_snapshot
...
grant execute on function public.save_financial_model_snapshot(uuid, timestamptz, jsonb, jsonb) to authenticated, service_role;
