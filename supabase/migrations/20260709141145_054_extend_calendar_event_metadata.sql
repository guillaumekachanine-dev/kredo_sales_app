...
COMMENT ON FUNCTION public.create_calendar_event IS
  'Création atomique d''un événement agenda et de sa tâche préparatoire optionnelle. Accepte metadata JSONB pour les liens CRM étendus. SECURITY INVOKER — RLS respecté.';
