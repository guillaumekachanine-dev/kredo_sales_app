...
> 📌 **Mise à jour 2026-07-26 :** vérifié en base, **12 secteurs sur 14 sont actifs** (+ `commerce-distribution-services-specialises` le 18/07 et `ehpad-residences-seniors` le 26/07). Il ne reste que **2 « watch »** : `secteur-public-enseignement-recherche` (0 interaction, aucun verbatim possible) et `transport-mobilite-regionale` (**seul secteur encore concerné par la dette #10** — son rang 🥈 repose sur 18 interactions jamais passées au filtre synthétique ; à vérifier avant de l'attaquer).
