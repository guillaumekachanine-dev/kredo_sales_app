...
| 1 | Types canoniques et compatibilité legacy : six catégories, destinataire collaborateur, dimensions Staff, scénarios nouveaux déclarés, normalisation historique. Sans UI, sans DB, sans n8n. | À affecter | `feat/intel-020-dynamic-01-*` | — | Aucune prévue | À définir | planned | — |
| 2 | Registry exhaustive : scinder les catégories, reclasser les scénarios, ajouter les 19 nouveaux identifiants, enrichir le contrat de registry. | À affecter | `feat/intel-020-dynamic-02-*` | — | Aucune prévue | Tests d'intégrité obligatoires | planned | — |
| 3 | Résolveur de dépendances : créer les facts, le resolver, les cascades et la gestion `auto \| user`. | À affecter | `feat/intel-020-dynamic-03-*` | — | Aucune prévue | Tests table-driven couvrant toutes les catégories et finalités | planned | — |
| 4 | Fondation Supabase Management : `manager_profile_id`, index, backfill sûr, RPC collaborateur, types générés. Pas d'UI. | À affecter | `feat/intel-020-dynamic-04-*` | — | Décidée, différée à ce lot | À définir | planned | — |
