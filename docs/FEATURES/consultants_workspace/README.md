...
> **Statut global : en cours (Lots 0-4 livrés)**
...
➡️ **Lot 5 — Migration Activités & congés** (voir `00-REFERENCE-CHANTIER-CONSULTANTS.md` § Lot 5).
...
- Lot 3 : page Synthèse Desktop + Mobile — KPI, graphiques SVG/HTML maison, tableaux ; `page.tsx` charge par section (C-21/C-22).
- Lot 4 : chapitre Collaborateurs dans `src/features/consultants/collaborators/` ; statut ⇐ `collaborators.status` (C-23 / LEGACY-4) ; effectif actif (29, hors `sorti`).
